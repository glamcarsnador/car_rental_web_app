  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-3xl font-bold text-main-text tracking-tight">{t('finances')}</h1>
      </div>
      ...
      <div className={cn("h-96 w-full bg-module-bg/50 rounded-xl border border-border-main flex items-center justify-center text-muted-text font-medium", pulseClass)}>
