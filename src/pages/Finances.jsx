  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className={cn("h-64 bg-slate-800/50 rounded-xl border border-slate-700/50", pulseClass)} />
        <div className={cn("h-64 bg-slate-800/50 rounded-xl border border-slate-700/50", pulseClass)} />
      </div>
      <div className={cn("h-80 w-full bg-slate-800/50 rounded-xl border border-slate-700/50", pulseClass)} />
    </div>
  );
}
