...
export default function Unauthorized() {
  ...
  return (
    <div className="min-h-screen bg-body-bg flex items-center justify-center p-4 transition-colors duration-500">
      <div className="max-w-md w-full text-center space-y-6 bg-module-bg/50 p-10 rounded-2xl border border-red-500/20 backdrop-blur-sm shadow-2xl">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-red-500/10 text-red-500 mb-4">
          <ShieldAlert size={48} />
        </div>
        <div className="space-y-2">
          <h2 className="text-3xl font-bold text-main-text">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-module-bg hover:bg-border-main text-main-text font-bold py-3 px-8 rounded-xl transition-all duration-200 border border-border-main"
        >
          <LogOut size={20} />
          {t('logout')}
        </button>
