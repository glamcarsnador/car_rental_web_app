  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className={cn("lg:col-span-2 h-96 bg-module/50 rounded-xl border border-border", pulseClass)} />
        <div className={cn("h-96 bg-module/50 rounded-xl border border-border", pulseClass)} />
      </div>
    </div>
  );
}
