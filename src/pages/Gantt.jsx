  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-3xl font-bold text-main tracking-tight">{t('gantt')}</h1>
      </div>
      
      {/* Skeleton Content */}
      <div className="grid grid-cols-1 gap-6">
        <div className={cn("h-[600px] w-full bg-module/50 rounded-xl border border-border flex items-center justify-center text-muted font-medium", pulseClass)}>
