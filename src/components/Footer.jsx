...
export default function Footer() {
  ...
  return (
    <footer className="grid-in-footer h-14 bg-body border-t border-border flex items-center justify-between px-6 text-[10px] sm:text-xs transition-colors duration-300">
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-2 text-muted uppercase tracking-widest font-semibold">
          <Database size={14} className="text-accent/50" />
          <span>Supabase</span>
        </div>
        <div className="flex items-center gap-2 text-muted uppercase tracking-widest font-semibold">
